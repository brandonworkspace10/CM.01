...
PAGES["services"] = dict(
    ...
    faqs=[
        ...
        ("How is it priced?", "Flat monthly pricing, no per-minute or per-lead charges. Plans start at $297/month for after-hours coverage and $497/month for full 24/7 answering; additional services are added to your plan, not billed per use. See the <a href='/pricing' style='color:var(--accent);'>pricing page</a> for details."),
